...
public class DevolucaoLivro {
	...
	public String toString() {
		return "Id: " + id + " | Locacao: "  + "Aluno: " + locacao.getAluno().getId() + " - " + locacao.getAluno().getNome() + " | Livro: "  + locacao.getLivro().getId() + " - " + locacao.getLivro().getTitulo() + " | Data entrega: " + locacao.getDataEntrega() + " | Data entregue: " + dataEntregue;
	}
